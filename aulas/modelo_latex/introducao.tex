...
\begin{frame}{Python (em 2026?)}
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{./introducao_figs/python2025.jpeg}
    \end{figure}
\end{frame}
...
\begin{frame}{VSCodium: Depuração (Debug)}
    ...
    %\textbf{Vantagem principal:}  Entender \textbf{como} o programa executa, não apenas o resultado final.\\
    \textbf{Alterar as configurações do VSCodium devido a um bug do Pixi}
    \begin{itemize}
        \item File - Preferences - Settings
        \item Python - Terminal: Activate Environment - Disable
    \end{itemize}
