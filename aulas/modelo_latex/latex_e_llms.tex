...
\begin{document}
    ...
    \begin{frame}{Figura Vetorial com TikZ}
        ...
        \begin{center}
            \input{latex_e_llms_figs/drones.tex}
        \end{center}
    ...
    *** Revisão técnica
    ...
    \begin{frame}{Geração de Equações}
        Ex.: Produza um código com dados sintéticos exemplificando o método dos mínimos quadrados e um slide beamer que mostra as equações do método.
...
\textbf{Solução fechada (equações normais):}
