...
\begin{document}
	...
	\begin{frame}{Boas práticas em PyQt6}
		...
		\textbf{Próximo passo:}
		\begin{itemize}
			\item Criar janelas com múltiplos widgets
			\item Integrar com dados (ex.: GeoPandas)
		\end{itemize}
		...
		\begin{center}
			\fbox{
				\parbox[c][5cm][c]{0.8\textwidth}{
					\centering
					\textbf{Inserir aqui o diagrama UML da aplicação}\\
					(QApplication, MainWindow, Widgets)
				}
			}
		\end{center}
