...
\begin{frame}{GitHub Desktop — Clonar repositório}
	...
	\begin{columns}[T]
		\begin{column}{0.48\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=\columnwidth]{GIT_figs/clone}
			\end{figure}
		\end{column}
		...
		\begin{column}{0.48\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=\columnwidth]{GIT_figs/clone1}
			\end{figure}
...
\begin{frame}{GitHub Desktop — Ver modificações}
	...
	\begin{columns}[T]
		...
		\begin{figure}
			\centering
			\includegraphics[width=\columnwidth]{GIT_figs/diff2}
		\end{figure}
...
\begin{frame}{GitHub Desktop — Commit}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.7\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=\columnwidth]{GIT_figs/commit}
			\end{figure}
		\end{column}
	\end{columns}
