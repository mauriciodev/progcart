...
\begin{frame}{GitHub Desktop — Clonar repositório}
	...
	\begin{columns}[T]
		\begin{column}{0.3\textwidth}
			...
			\begin{itemize}
				\item File $\rightarrow$ Clone repository
				\item Escolher o repositório:\\ \url{https://github.com/mauriciodev/progcart}
				\item Definir pasta local
			\end{itemize}
		...
		\begin{column}{0.7\textwidth}
			\centering
			\includegraphics[width=\linewidth]{figs/github_clone.png}
		\end{column}
	\end{columns}
...
\begin{frame}{GitHub Desktop — Ver modificações}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.7\textwidth}
			\centering
			%\includegraphics[width=\linewidth]{figs/github_changes.png}
		\end{column}
	\end{columns}
...
\begin{frame}{GitHub Desktop — Commit}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.7\textwidth}
			\centering
			%\includegraphics[width=\linewidth]{figs/github_commit.png}
		\end{column}
	\end{columns}
...
\begin{frame}{GitHub Desktop — Push e Pull}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.7\textwidth}
			\centering
			%\includegraphics[width=\linewidth]{figs/github_push_pull.png}
		\end{column}
	\end{columns}
